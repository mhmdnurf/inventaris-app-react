  ...
  return (
    <>
      <div className="min-w-screen flex flex-wrap">
        <div className="mx-2 my-4 flex flex-1 flex-wrap rounded-xl border-2 bg-white transition-transform duration-300 ease-in-out hover:scale-105 hover:transform">
          <img
            src="/coffee.svg"
            alt=""
